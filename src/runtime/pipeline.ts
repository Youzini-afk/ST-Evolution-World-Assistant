...
export async function runWorkflow(
  ...
  try {
    ...
    commitSummary = {
      ...
      controller_entries_created: commitResult.controller_entries_created,
      controller_entries_changed: commitResult.controller_entries_changed,
      controller_entries_removed: commitResult.controller_entries_removed,
